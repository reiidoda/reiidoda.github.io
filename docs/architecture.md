...
The home page does not mirror a latest-news surface.

## Experience and Resume

- Experience route: [`experience.md`](../experience.md) -> `/experience/`
- Resume route: [`cv.md`](../cv.md) -> `/resume/`
- Legacy resume redirect: [`cv/index.html`](../cv/index.html) -> `/cv/`
...
- `BreadcrumbList` on news, projects, experience, and resume routes
